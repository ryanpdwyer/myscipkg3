...
myscipkg3 could always use more documentation, whether as part of the 
official myscipkg3 docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `myscipkg3` for
local development.

1. Fork_ the `myscipkg3` repo on GitHub.
...
.. _Fork: https://github.com/Nekroze/myscipkg3/fork
...
3. The pull request should work for Python 2.7.
   Check https://travis-ci.org/ryanpdwyer/myscipkg3 
